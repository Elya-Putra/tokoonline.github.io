...
<body>
        ...
        <ul>
          ...
          <li>
            <form class="pencarian d-flex" role="search">
              <input name="key" class="form-control me-2" type="search" placeholder="Cari disini" aria-label="Search">
  ...
  <section class="isi">
    <div class="container">
      <div class="row for-sale-lihat-semua">
        <div class="content-flex">
          <h1>FOR SALE</h1>
          <h2><i class="fa-regular fa-clock"></i>BERAKHIR DALAM</h2>
    ...
    $where = " WHERE 1=1 ";
							if(isset($_GET['key'])){
								$where .=" AND kode_produk LIKE '%".addslashes($_GET['key'])."%' ";
							}

    $sql="SELECT * FROM keranjang $where order by id_produk desc";
